    ...
    /* join_room_response:
        {
            ...
            'socket_id': the socket of the user taht just joined the room
        }
    or
        {
            'result': 'fail',
...
/**************************************/
/* Code related related to game state */
...
function adjacent_support(who,dr,dc,r,c,board) {
    ...
    /* Check to make sure that the adjacent supprot is on the board */
    if ((r + dr < 0) || (r + dr > 7)) {
        return false;
    }
    if ((c + dc < 0) || (c + dc > 7)) {
...
function send_game_update(socket, game_id, message) {
    ...
    /* Make sure othat only 2 people are in the room */
        ...
        if(sockets.size >= 1) {
            ...
            if((games[game_id].player_white.socket != first) &&
                ...
                if (games[game_id].player_white.socket === '') {
                    ...
                    /* This player whould be kicked out */
